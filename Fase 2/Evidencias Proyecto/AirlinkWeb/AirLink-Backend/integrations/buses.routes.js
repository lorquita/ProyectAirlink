...
const RUTAS_PRINCIPALES = [
  // Desde Santiago
  { origen: "Santiago", destino: "Valparaíso", duracionMin: 120, distanciaKm: 120, empresas: ["TURBUS", "PULLMAN", "CONDOR"] },
  { origen: "Santiago", destino: "Viña del Mar", duracionMin: 130, distanciaKm: 120, empresas: ["TURBUS", "PULLMAN", "CONDOR"] },
  { origen: "Santiago", destino: "La Serena", duracionMin: 360, distanciaKm: 470, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Santiago", destino: "Concepción", duracionMin: 480, distanciaKm: 500, empresas: ["TURBUS", "PULLMAN", "CRUZ_DEL_SUR"] },
  { origen: "Santiago", destino: "Temuco", duracionMin: 600, distanciaKm: 680, empresas: ["TURBUS", "JAC", "CRUZ_DEL_SUR"] },
  { origen: "Santiago", destino: "Puerto Montt", duracionMin: 720, distanciaKm: 1020, empresas: ["TURBUS", "CRUZ_DEL_SUR"] },
  { origen: "Santiago", destino: "Rancagua", duracionMin: 90, distanciaKm: 87, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Santiago", destino: "Talca", duracionMin: 240, distanciaKm: 255, empresas: ["TURBUS", "PULLMAN", "ROMANI"] },
  { origen: "Santiago", destino: "Chillán", duracionMin: 360, distanciaKm: 400, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Santiago", destino: "Los Ángeles", duracionMin: 420, distanciaKm: 490, empresas: ["TURBUS", "JAC"] },
  { origen: "Santiago", destino: "Antofagasta", duracionMin: 1320, distanciaKm: 1370, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Santiago", destino: "Iquique", duracionMin: 1680, distanciaKm: 1850, empresas: ["TURBUS"] },
  
  // Desde Valparaíso/Viña
  { origen: "Valparaíso", destino: "Santiago", duracionMin: 120, distanciaKm: 120, empresas: ["TURBUS", "PULLMAN", "CONDOR"] },
  { origen: "Valparaíso", destino: "La Serena", duracionMin: 300, distanciaKm: 400, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Viña del Mar", destino: "Santiago", duracionMin: 130, distanciaKm: 120, empresas: ["TURBUS", "PULLMAN", "CONDOR"] },
  { origen: "Viña del Mar", destino: "La Serena", duracionMin: 290, distanciaKm: 400, empresas: ["TURBUS", "PULLMAN"] },
  
  // Desde La Serena
  { origen: "La Serena", destino: "Santiago", duracionMin: 360, distanciaKm: 470, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "La Serena", destino: "Antofagasta", duracionMin: 780, distanciaKm: 900, empresas: ["TURBUS"] },
  { origen: "La Serena", destino: "Coquimbo", duracionMin: 20, distanciaKm: 15, empresas: ["TURBUS", "PULLMAN"] },
  
  // Desde Concepción
  { origen: "Concepción", destino: "Santiago", duracionMin: 480, distanciaKm: 500, empresas: ["TURBUS", "PULLMAN", "CRUZ_DEL_SUR"] },
  { origen: "Concepción", destino: "Temuco", duracionMin: 180, distanciaKm: 240, empresas: ["TURBUS", "JAC"] },
  { origen: "Concepción", destino: "Valdivia", duracionMin: 240, distanciaKm: 330, empresas: ["TURBUS", "JAC"] },
  { origen: "Concepción", destino: "Los Ángeles", duracionMin: 60, distanciaKm: 110, empresas: ["TURBUS", "JAC"] },
  
  // Desde Temuco
  { origen: "Temuco", destino: "Santiago", duracionMin: 600, distanciaKm: 680, empresas: ["TURBUS", "JAC", "CRUZ_DEL_SUR"] },
  { origen: "Temuco", destino: "Puerto Montt", duracionMin: 300, distanciaKm: 350, empresas: ["TURBUS", "CRUZ_DEL_SUR"] },
  { origen: "Temuco", destino: "Valdivia", duracionMin: 120, distanciaKm: 166, empresas: ["TURBUS", "JAC"] },
  { origen: "Temuco", destino: "Concepción", duracionMin: 180, distanciaKm: 240, empresas: ["TURBUS", "JAC"] },
  
  // Desde Puerto Montt
  { origen: "Puerto Montt", destino: "Santiago", duracionMin: 720, distanciaKm: 1020, empresas: ["TURBUS", "CRUZ_DEL_SUR"] },
  { origen: "Puerto Montt", destino: "Temuco", duracionMin: 300, distanciaKm: 350, empresas: ["TURBUS", "CRUZ_DEL_SUR"] },
  { origen: "Puerto Montt", destino: "Osorno", duracionMin: 120, distanciaKm: 110, empresas: ["TURBUS", "JAC"] },
  { origen: "Puerto Montt", destino: "Punta Arenas", duracionMin: 1800, distanciaKm: 1900, empresas: ["TURBUS"] },
  
  // Desde Antofagasta
  { origen: "Antofagasta", destino: "Santiago", duracionMin: 1320, distanciaKm: 1370, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Antofagasta", destino: "Iquique", duracionMin: 360, distanciaKm: 400, empresas: ["TURBUS"] },
  { origen: "Antofagasta", destino: "Calama", duracionMin: 120, distanciaKm: 215, empresas: ["TURBUS"] },
  
  // Rutas intermedias
  { origen: "Rancagua", destino: "Santiago", duracionMin: 90, distanciaKm: 87, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Talca", destino: "Santiago", duracionMin: 240, distanciaKm: 255, empresas: ["TURBUS", "PULLMAN", "ROMANI"] },
  { origen: "Chillán", destino: "Concepción", duracionMin: 60, distanciaKm: 100, empresas: ["TURBUS", "PULLMAN"] },
  { origen: "Osorno", destino: "Valdivia", duracionMin: 120, distanciaKm: 110, empresas: ["TURBUS", "JAC"] },
];

// Horarios típicos de salida (se generan dinámicamente por ruta)
const HORARIOS_TIPO = {
  "Santiago-Valparaíso": ["07:00", "08:30", "10:00", "12:00", "14:30", "16:00", "18:00", "20:00"],
  "Santiago-Viña del Mar": ["07:30", "09:00", "11:00", "13:00", "15:30", "17:00", "19:00", "20:30"],
  "Santiago-La Serena": ["08:00", "10:00", "13:00", "16:00", "20:00", "22:00"],
  "Santiago-Concepción": ["07:00", "09:00", "11:00", "14:00", "17:00", "20:00", "22:30"],
  ...
  ruta.empresas.forEach(empresaKey => {
    ...
    horarios.forEach((hora, index) => {
      ...
      viajes.push({
        ...
        fechaSalida: salida.toLocaleDateString('es-CL', { weekday: 'short', day: '2-digit', month: '2-digit' }),
        fechaCompleta: fecha,
        horaSalida: hora,
        horaLlegada: `${String(llegada.getHours()).padStart(2, '0')}:${String(llegada.getMinutes()).padStart(2, '0')}`,
...
async function geocodificarCiudad(nombreCiudad) {
  try {
    const url = `https://nominatim.openstreetmap.org/search?city=${encodeURIComponent(nombreCiudad)}&country=Chile&format=json&limit=1`;
    ...
    if (!response.ok) {
      console.warn(`⚠️ Error geocodificando ${nombreCiudad}: ${response.status}`);
      return null;
    }
    ...
    console.error(`❌ Error en geocodificación de ${nombreCiudad}:`, error.message);
    return null;
  }
}

async function calcularDistanciaRuta(origenLat, origenLon, destinoLat, destinoLon) {
  try {
...
router.get("/disponibles", async (req, res) => {
  try {
    ...
    if (busesBaseDatos.length === 0) {
      ...
      if (terminalEstatico) {
        ...
        if (ciudadOrigen && ciudadDestino) {
          ...
          busesEstaticos = generarViajesEstaticos(ciudadOrigen, ciudadDestino, fechaObj);
    ...
    const busesFormateados = buses.map((bus) => {
      const fechaHoraMinima = fecha && horaLlegadaVuelo 
        ? `${fecha} ${horaLlegadaVuelo}:00` 
        : null;
...
router.get("/conexiones/:ciudad", async (req, res) => {
  try {
    ...
    if (conexiones.length === 0) {
      ...
      const rutasDesdeOrigen = RUTAS_PRINCIPALES.filter(r => r.origen === ciudad);
...
router.get("/distancia/:origen/:destino", async (req, res) => {
  try {
    ...
    res.json({
      ...
      coordenadasDestino: { lat: terminalDestino.lat, lon: terminalDestino.lon },
    });
  } catch (error) {
